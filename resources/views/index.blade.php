<x-app-layout>
    ...
    <div class="filters flex space-x-6">
        <div class="w-1/3">
            <select name="category" id="" class="w-full rounded-xl border-none px-4 py-2">
        ...
        <div class="w-1/3">
            <select name="other_filters" id="" class="w-full rounded-xl border-none px-4 py-2">
            ...
            <div class="flex px-2 py-6">
                ...
                <div class="mx-4">
                    ...
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum impedit quis quo veritatis vero. A accusamus aliquam, architecto assumenda autem consequatur delectus distinctio doloribus enim esse eum eveniet fuga fugiat illum inventore laudantium molestias nemo nesciunt officia perspiciatis, placeat quae quisquam quod, quos suscipit! A, ab alias animi asperiores assumenda autem beatae blanditiis cumque distinctio eveniet expedita explicabo facilis illum impedit ipsam minus mollitia nam necessitatibus nemo neque nostrum obcaecati pariatur perferendis quas qui quia quibusdam repellat sapiente tempora ullam unde veniam voluptas voluptates! A aliquam, animi consequuntur cumque dolore dolorum ducimus, in libero maxime minima, nemo possimus sunt velit?
                    </div>
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="realtive bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in py-2 px-3">
