...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 text-sm bg-gray-background">
        <header class="flex items-center justify-between px-8 py-4">
            <a href="#" class="text-xl text-gray-700">My voting page</a>
            ...
            <div class="w-70 mr-5">
                <div class="bg-white border-2 border-blue rounded-xl mt-16" style="
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        <input type="text" class="text-sm w-full bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2"
                        placeholder="Your idea">
                        <div>
                            <select name="category_add" id="category_add" class="bg-gray-100 w-full rounded-xl border-none
                            px-4 py-2 text-sm">
                        ...
                        <div>
                            ...
                            placeholder-gray-900 text-sm px-4 py-2 border-none" placeholder="Describe your idea">
                            </textarea>
                        </div>
                        <div class="flex items-center justify-between space-x-3">
                            <button type="button" class="flex item-center justify-center w-1/2 h-11 text-sm bg-gray-200
                            ...
                            <button type="submit" class="flex item-center justify-center w-1/2 h-11 text-sm bg-blue
