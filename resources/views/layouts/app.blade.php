...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 text-sm bg-gray-background">
        ...
        <main class="container mx-auto max-w-custom flex" style="max-width: 1000px">
            <div class="w-70 mr-5">
                Add idea form goes here. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio, ea eius ex maxime nostrum quas quo! Distinctio enim est facilis illo ipsa iusto mollitia nobis provident, quo quod reprehenderit rerum sit sunt veniam, veritatis! Aut exercitationem natus quidem sed unde!
            </div>
            <div class="w-175">
