<x-app-layout>
        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo nobis suscipit tempora? Accusamus animi asperiores dolore laboriosam nemo perferendis praesentium quis rem sed voluptatum! Atque excepturi id nam quis similique.
                </div>
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button class="realtive bg-gray-100 hover:bg-gray-200 border rounded-full h-7 transition duration-150 ease-in py-2 px-3">
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            <div class="relative">
                <button type="button" class="flex item-center justify-center h-11 w-32 text-sm bg-blue
                            font-semibold text-white rounded-xl border border-blue hover:bg-blue-hover
                    ...
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div>
                            <textarea name="post_comment" id="post_comment" cols="30" rows="4"
                                  ...
                                  border-none px-4 py-2" placeholder="Go ahead, don't be shy. Share your thoughts...">
                            </textarea>
                        </div>

                        <div class="flex items-center space-x-3">
                            <button type="button" class="flex item-center justify-center h-11 w-1/2 text-sm bg-blue
                            font-semibold text-white rounded-xl border border-blue hover:bg-blue-hover
                            transition duration-150 ease-in px-6 py-3">Post Comment</button>

                            <button type="button" class="flex item-center justify-center w-32 h-11 text-sm bg-gray-200
            ...
            <div class="relative">
                <button type="button" class="flex item-center justify-center h-11 w-36 text-sm bg-gray-200
                            font-semibold rounded-xl border border-gray-200 hover:border-gray-400
                            transition duration-150 ease-in px-6 py-3">
        ...
        <div class="flex items-center space-x-3">
            ...
            <button type="button" class="h-11 w-32 text-sm bg-gray-200
